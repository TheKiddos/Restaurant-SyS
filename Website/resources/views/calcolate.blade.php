                            ...
                            @foreach($d as $n)
                                ...
                                <tr>
                                    ...
                                    <td><a href="" id="{{$n->id}}" data-name="{{$n->name}}" data-id="{{$n->id}}"
                                           data-price="{{$n->price}}" data-calories="{{$n->calories}}"
                                           data-fat="{{$n->fat}}" data-brotien="{{$n->brotien}}"  data-kerbohedrat="{{$n->kerbohedrat}}" class="btn btn-warning btn-sm add">+</a></td>
                                </tr>
