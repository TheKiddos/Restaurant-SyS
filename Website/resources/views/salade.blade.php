...
<div class=container-fluid">
    ...
    <div style="margin-left:30%;padding:1px 16px;height:1000px;">
        <h1 style="text-align: center;font-size: 50px"><strong>Salads</strong></h1>

        <div class="gallery">
            <a target="_blank" href="http://127.0.0.1:8000/en/home/main/menu/BaconSalad">
                <img src="{{ asset('food15.jpg') }}" alt="Northern Lights" width="600" height="400" >
            </a>
            <div class="desc">
                Bacon Ranch Salad with Buttermilk Crispy Chicken</div>
        </div>

        <div class="gallery">
            <a target="_blank" href="http://127.0.0.1:8000/en/home/main/menu/BaconGrilled">
                <img src="{{ asset('food15.jpg') }}" alt="Mountains" width="600" height="400" >
            </a>
            <div class="desc">
        ...
        <div class="gallery">
            <a target="_blank" href="http://127.0.0.1:8000/en/home/main/menu/SideSalad">
                <img src="{{ asset('food15.jpg') }}" alt="Mountains" width="600" height="400" >
            </a>
            <div class="desc"> Side Salad</div>
        </div>

        <div class="gallery">
            <a target="_blank" href="http://127.0.0.1:8000/en/home/main/menu/Southwest">
                <img src="{{ asset('food15.jpg') }}" alt="Mountains" width="600" height="400" >
            </a>
            <div class="desc">
