...
<div class=container-fluid">
    ...
    <div style="margin-left:30%;padding:1px 16px;height:1000px;">
        <h1 style="text-align: center;font-size: 50px"><strong>Desserts & shakes   </strong></h1>

        <div class="gallery">
            <a target="_blank" href="http://127.0.0.1:8000/en/home/main/menu/ChocolateChip">
                <img src="{{ asset('food14.jpg') }}" alt="Northern Lights" width="600" height="400" >
            </a>
            <div class="desc">
        ...
        <div class="gallery">
            <a target="_blank" href="http://127.0.0.1:8000/en/home/main/menu/BakedApple">
                <img src="{{ asset('food40.jpg') }}" alt="Mountains" width="600" height="400" >
            </a>
            <div class="desc"> Baked Apple Pie</div>
        </div>

        <div class="gallery">
            <a target="_blank" href="http://127.0.0.1:8000/en/home/main/menu/Strawberry">
                <img src="{{ asset('food41.jpg') }}" alt="Mountains" width="600" height="400" >
            </a>
            <div class="desc"> Strawberry Shake </div>
        </div>

        <div class="gallery">
            <a target="_blank" href="http://127.0.0.1:8000/en/home/main/menu/HotFudge">
                <img src="{{ asset('food42.jpg') }}" alt="Mountains" width="600" height="400" >
            </a>
            <div class="desc">
