...
<div class=container-fluid">
    ...
    <div style="margin-left:30%;padding:1px 16px;height:1000px;">
        <h1 style="text-align: center;font-size: 50px"><strong>  Combo Meal</strong></h1>

        <div class="gallery">
            <a target="_blank" href="http://127.0.0.1:8000/en/home/main/menu/CheeseburgerCombo">
                <img src="{{ asset('food35.jpg') }}" alt="Northern Lights" width="600" height="400" >
            </a>
            <div class="desc">Cheeseburger Combo Meal</div>
        </div>

        <div class="gallery">
            <a target="_blank" href="http://127.0.0.1:8000/en/home/main/menu/ArtisanMeal">
                <img src="{{ asset('food36.jpg') }}" alt="Mountains" width="600" height="400" >
            </a>
            <div class="desc">
                Artisan Grilled Chicken Sandwich Meal</div>
        </div>

        <div class="gallery">
            <a target="_blank" href="http://127.0.0.1:8000/en/home/main/menu/ButtermilkMeal">
                <img src="{{ asset('food37.jpg') }}" alt="Mountains" width="600" height="400" >
            </a>
            <div class="desc"> Buttermilk Crispy Chicken Sandwich Meal</div>
        </div>

        <div class="gallery">
            <a target="_blank" href="http://127.0.0.1:8000/en/home/main/menu/QuarterMeal">
                <img src="{{ asset('food38.jpg') }}" alt="Mountains" width="600" height="400" >
            </a>
            <div class="desc">
                Quarter Pounder®* with Cheese Meal</div>
        </div>
    </div>
</div>
</body>
